...
CREATE SEQUENCE repuesto_key_sequence --SECUENCIA PARA EL NUMERO DE VENTA EN LA TABLA VENTA WEB 
	START WITH 1
	INCREMENT BY 1;
...
CREATE SEQUENCE orden_key_sequence --SECUENCIA EL CAMPO AUTOINCREMENTAL NUMERO DEL MODELO DE LA TABLA MODELO
	START WITH 1
	INCREMENT BY 1;
...
CREATE SEQUENCE venta_web_key_sequence --SECUENCIA PARA EL NUMERO DE VENTA EN LA TABLA VENTA WEB 
	START WITH 1
	INCREMENT BY 1;
...
CREATE SEQUENCE factura_compra_key_sequence --SECUENCIA PARA EL NUMERO DE VENTA EN LA TABLA VENTA WEB 
	START WITH 1
	INCREMENT BY 1;

CREATE TABLE cuenta_por_pagar(
	numero NUMBER NOT NULL ENABLE, --Clave parcial añadida por el DBA Eduardo.
	...
	CONSTRAINT CUENTA_POR_PAGAR_PK PRIMARY KEY (numero, numero_factura_compra, rif_proveedor),
	CONSTRAINT CUENTA_POR_PAGAR_FK_RIF_PROVEEDOR FOREIGN KEY rif_proveedor REFERENCES proveedor(rif),
	CONSTRAINT CUENTA_POR_PAGAR_FK_FACTURA_COMPRA FOREIGN KEY numero_factura_compra REFERENCES factura_compra(numero),
	CONSTRAINT CUENTA_POR_PAGAR_CH_MONTO CHECK (monto >= 0) ENABLE,
	CONSTRAINT CUENTA_POR_PAGAR_CH_SALDO CHECK (saldo >= 0) ENABLE
);

CREATE SEQUENCE cuenta_por_pagar_key_sequence --SECUENCIA PARA EL NUMERO DE VENTA EN LA TABLA VENTA WEB 
	START WITH 1
	INCREMENT BY 1;
...
CREATE TABLE abono(
	...
	numero_factura_compra NUMBER NOT NULL ENABLE,
	numero_cuenta_por_pagar NUMBER,
	...
	CONSTRAINT ABONO_FK_CUENTA_POR_PAGAR FOREIGN KEY numero_cuenta_por_pagar REFERENCES cuenta_por_pagar(numero),
	CONSTRAINT ABONO_FK_FACTURA FOREIGN KEY (rif_proveedor,numero_factura_compra) REFERENCES factura_compra(rif_proveedor,numero), --DUDA CON LA PROFESORA: DEBO REPETIR ESTA CLAVE DESDE CUENTA POR PAGAR Y DESDE FACTURA?
...
CREATE SEQUENCE factura_venta_key_sequence --SECUENCIA PARA EL NUMERO DE FACTURA EN LA FACTURA 
	START WITH 1
	INCREMENT BY 1;
...
CREATE TABLE cuenta_por_cobrar(
	...
	monto NUMBER(10,2) NOT NULL ENABLE DEFAULT 0,
	saldo NUMBER(10,2) NOT NULL ENABLE DEFAULT 0,
	CONSTRAINT CUENTA_POR_COBRAR_PK PRIMARY KEY (numero, numero_factura_venta, doc_id_cliente),
	CONSTRAINT CUENTA_POR_COBRAR_FK_FACTURA_VENTA FOREIGN KEY numero_factura_venta REFERENCES factura_venta(numero),
	CONSTRAINT CUENTA_POR_COBRAR_FK_DOC_ID_CLIENTE FOREIGN KEY doc_id_cliente REFERENCES cliente(doc_identidad),
...
CREATE TABLE pago(
	...
	CONSTRAINT PAGO_FK_FACTURA_VENTA FOREIGN KEY numero_factura_venta REFERENCES factura_venta(numero),
