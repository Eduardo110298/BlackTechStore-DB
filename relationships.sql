...
CREATE TABLE cuenta(
	...
	CONSTRAINT CUENTA_FK_RIF_TIENDA FOREIGN KEY rif_tienda REFERENCES tienda(rif) ON DELETE RESTRICT,
...
CREATE TABLE herramienta(
	...
	CONSTRAINT HERRAMIENTA_FK_CED_TECNICO FOREIGN KEY ced_tecnico REFERENCES empleado_tecnico(cedula) ON DELETE SET NULL,
...
CREATE TABLE equipo(
	...
	CONSTRAINT EQUIPO_FK_CODIGO_MODELO FOREIGN KEY codigo_modelo REFERENCES modelo(codigo) ON DELETE RESTRICT,
...
CREATE TABLE orden(
	...
	CONSTRAINT ORDEN_FK_DOC_IDENTIDAD_CLIENTE FOREIGN KEY doc_identidad_cliente REFERENCES cliente(doc_identidad) ON DELETE RESTRICT,
...
CREATE TABLE pertenece_a(
	...
	CONSTRAINT PERTENECE_FK_NUMERO_ORDEN FOREIGN KEY numero_orden REFERENCES orden(numero) ON DELETE RESTRICT,
	CONSTRAINT PERTENECE_FK_SERIAL_EQUIPO FOREIGN KEY serial_equipo REFERENCES equipo(serial_equipo) ON DELETE RESTRICT
);
...
CREATE TABLE reparacion(
	...
	CONSTRAINT REPARACION_FK_NUMERO_ORDEN FOREIGN KEY numero_orden REFERENCES orden(numero) ON DELETE RESTRICT,
	CONSTRAINT REPARACION_FK_CEDULA_TECNICO FOREIGN KEY cedula_tecnico REFERENCES empleado_tecnico(cedula) ON DELETE RESTRICT,
...
CREATE TABLE usa(
	...
	CONSTRAINT USA_FK_REPUESTO FOREIGN KEY cod_repuesto REFERENCES repuesto(cod_repuesto) ON DELETE RESTRICT,
	CONSTRAINT USA_FK_REPARACION FOREIGN KEY (fecha_hora_reparacion, cedula_tecnico_reparacion, numero_orden_reparacion) REFERENCES reparacion(fecha_hora, numero_orden, cedula_tecnico) ON DELETE RESTRICT,	
...
CREATE TABLE factura_compra(
	...
	CONSTRAINT FACTURA_COMPRA_FK_RIF_PROVEEDOR FOREIGN KEY rif_proveedor REFERENCES proveedor(rif) ON DELETE RESTRICT,
...
CREATE TABLE actualiza_articulo(
	...
	CONSTRAINT ACTUALIZA_ARTICULO_FK_FACTURA FOREIGN KEY (rif_proveedor,numero_factura_compra) REFERENCES factura_compra(rif_proveedor,numero) ON DELETE RESTRICT,
	CONSTRAINT ACTUALIZA_ARTICULO_FK_ARTICULO FOREIGN KEY codigo_articulo REFERENCES articulo(codigo) ON DELETE RESTRICT,
...
CREATE TABLE actualiza_repuesto(
	...
	CONSTRAINT ACTUALIZA_REPUESTO_FK_FACTURA FOREIGN KEY (rif_proveedor,numero_factura_compra) REFERENCES factura_compra(rif_proveedor,numero) ON DELETE RESTRICT,
	CONSTRAINT ACTUALIZA_REPUESTO_FK_REPUESTO FOREIGN KEY codigo_repuesto REFERENCES repuesto(codigo) ON DELETE RESTRICT,
...
CREATE TABLE actualiza_herramienta( --Sin cantidad porque las herramientas se manejan por unidad.
	...
	CONSTRAINT ACTUALIZA_HERRAMIENTA_FK_FACTURA FOREIGN KEY (rif_proveedor,numero_factura_compra) REFERENCES factura_compra(rif_proveedor,numero) ON DELETE RESTRICT,
	CONSTRAINT ACTUALIZA_HERRAMIENTA_FK_HERRAMIENTA FOREIGN KEY codigo_herramienta REFERENCES herramienta(codigo) ON DELETE RESTRICT,
...
CREATE TABLE cuenta_por_pagar(
	...
	CONSTRAINT CUENTA_POR_PAGAR_FK_FACTURA_COMPRA FOREIGN KEY (numero_factura_compra,rif_proveedor) REFERENCES factura_compra(numero,rif_proveedor) ON DELETE RESTRICT,
...
CREATE TABLE abono(
	...
	CONSTRAINT ABONO_FK_NRO_CUENTA FOREIGN KEY numero_cuenta_tienda REFERENCES cuenta(numero) ON DELETE RESTRICT,
	CONSTRAINT ABONO_FK_FACTURA_COMPRA FOREIGN KEY (rif_proveedor_factura_compra, numero_factura_compra_factura_compra) REFERENCES factura_compra(rif_proveedor,numero) ON DELETE RESTRICT, --DUDA CON LA PROFESORA: DEBO REPETIR ESTA CLAVE DESDE CUENTA POR PAGAR Y DESDE FACTURA?
	CONSTRAINT ABONO_FK_CUENTA_POR_COBRAR FOREIGN KEY (rif_proveedor_cuenta_por_cobrar, numero_factura_compra_cuenta_por_cobrar) REFERENCES cuenta_por_cobrar(rif_proveedor,numero_factura_compra) ON DELETE RESTRICT, --DUDA CON LA PROFESORA: DEBO REPETIR ESTA CLAVE DESDE CUENTA POR PAGAR Y DESDE FACTURA?
...
CREATE TABLE factura_venta(
	...
	CONSTRAINT FACTURA_FK_DOC_CLIENTE FOREIGN KEY doc_identidad_cliente REFERENCES cliente(doc_identidad) ON DELETE RESTRICT,
	CONSTRAINT FACTURA_FK_NUMERO_ORDEN FOREIGN KEY numero_orden REFERENCES orden(numero) ON DELETE RESTRICT,
...
CREATE TABLE incluye(
	...
	CONSTRAINT INCLUYE_FK_FACTURA FOREIGN KEY numero_factura_venta REFERENCES factura(numero) ON DELETE RESTRICT,
	CONSTRAINT INCLUYE_FK_ARTICULO FOREIGN KEY codigo_articulo REFERENCES articulo(codigo) ON DELETE RESTRICT,
...
CREATE TABLE cuenta_por_cobrar(
	...
	CONSTRAINT CUENTA_POR_COBRAR_FK_FACTURA_VENTA FOREIGN KEY numero_factura_venta REFERENCES factura_venta(numero) ON DELETE RESTRICT,
	CONSTRAINT CUENTA_POR_COBRAR_FK_DOC_ID_CLIENTE FOREIGN KEY doc_identidad_cliente REFERENCES cliente(doc_identidad) ON DELETE RESTRICT,
...
CREATE TABLE pago(
	...
	CONSTRAINT PAGO_FK_NRO_CUENTA FOREIGN KEY numero_cuenta_tienda REFERENCES cuenta(numero) ON DELETE RESTRICT,
	CONSTRAINT PAGO_FK_FACTURA_VENTA FOREIGN KEY numero_factura_venta_factura_venta REFERENCES factura_venta(numero) ON DELETE RESTRICT,
	CONSTRAINT PAGO_FK_CUENTA_POR_COBRAR FOREIGN KEY (numero_factura_venta_cuenta_por_cobrar,doc_identidad_cliente_cuenta_por_cobrar) REFERENCES cuenta_por_cobrar(numero_factura_venta,doc_identidad_cliente) ON DELETE RESTRICT,
...
CREATE TABLE venta_web(
	...
	CONSTRAINT VENTA_WEB_FK_DOC_CLIENTE FOREIGN KEY doc_id_cliente REFERENCES cliente(doc_identidad) ON DELETE RESTRICT,
...
CREATE TABLE emite(
	...
	CONSTRAINT EMITE_FK_NUMERO_FACTURA FOREIGN KEY numero_factura_venta REFERENCES factura_venta(numero) ON DELETE RESTRICT,
	CONSTRAINT EMITE_FK_NUMERO_VENTA_WEB FOREIGN KEY numero_venta_web REFERENCES venta_web(numero) ON DELETE RESTRICT,
);
...
CREATE TABLE posee(
	...
	CONSTRAINT PAGO_FK_ARTICULO FOREIGN KEY codigo_articulo REFERENCES articulo(codigo) ON DELETE RESTRICT,
	CONSTRAINT PAGO_FK_NUMERO_VENTA_WEB FOREIGN KEY numero_venta_web REFERENCES venta_web(numero) ON DELETE RESTRICT,
...
--FALTAN ACCIONES REFERENCIALES UPDATE
