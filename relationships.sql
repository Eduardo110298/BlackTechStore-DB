...
CREATE TABLE articulo(
	...
	CONSTRAINT ARTICULO_CH_CANTEXIS CHECK (cant_existencia >= 0) ENABLE,
);
...
CREATE TABLE cliente(
	doc_identidad NUMBER(8) NOT NULL ENABLE,
	nombre VARCHAR(50) NOT NULL ENABLE,
...
CREATE TABLE cuenta(
	...
	tipo_cuenta CHAR(1) NOT NULL ENABLE,
	...
	CONSTRAINT CUENTA_CH_TIPO_CUENTA CHECK (tipo_cuenta IN('A','C')) ENABLE,
...
CREATE TABLE empleado(
	...
	apellido VARCHAR(50) NOT NULL ENABLE,
	telefono CHAR(11),
	nro_cuenta CHAR(20) NOT NULL ENABLE,
	nombre_banco VARCHAR(15) NOT NULL ENABLE,
	...
	CONSTRAINT EMPLEADO_CH_NRO_CUENTA CHECK (regexp_like (nro_cuenta, '^[[:digit:]]+$') and length(nro_cuenta)='20') ENABLE
);
...
CREATE TABLE empleado_tecnico(
	...
	tipo VARCHAR(20),
	CONSTRAINT EMPLEADO_PK PRIMARY KEY (cedula),
	CONSTRAINT EMPLEADO_CH_TIPO CHECK (tipo IN('HARDWARE', 'SOFTWARE', 'AMBAS')) ENABLE,
	CONSTRAINT EMPLEADO_CH_TELEFONO CHECK (regexp_like (telefono, '^[[:digit:]]+$') and length(telefono)='11') ENABLE, 
	CONSTRAINT EMPLEADO_CH_NRO_CUENTA CHECK (regexp_like (nro_cuenta, '^[[:digit:]]+$') and length(nro_cuenta)='20') ENABLE
);
...
CREATE TABLE herramienta(
	codigo NUMBER NOT NULL ENABLE, --HACER EL TRIGGER PARA ESTE ATRIBUTO AUTOINVREMENTAL
	costo NUMBER(10,2) NOT NULL ENABLE,
	nombre VARCHAR(50) NOT NULL ENABLE,
	descripcion VARCHAR(120),
	ced_tecnico NUMBER(8) NOT NULL ENABLE,
...
CREATE TABLE repuesto(
	cod_repuesto NUMBER NOT NULL ENABLE, --HACER UN TRIGGER PARA LA INSERCION Y SE AUTOINCREMENTE EL CAMPO
	costo NUMBER(10,2) NOT NULL ENABLE,
	nomb_repuesto VARCHAR(50) NOT NULL ENABLE,
	descripcion VARCHAR(120),
	cant_existencia INTEGER(4) NOT NULL ENABLE,
	CONSTRAINT REPUESTO_PK PRIMARY KEY (cod_repuesto),
	CONSTRAINT REPUESTO_CH_COSTO CHECK (costo >= 0)
);
