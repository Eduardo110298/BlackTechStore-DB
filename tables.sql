...
CREATE TABLE articulo(
	...
	costo NUMBER(10,2) DEFAULT 0 NOT NULL ENABLE,
	nombre VARCHAR(50) NOT NULL ENABLE,
	descripcion VARCHAR(120),
	cant_existencia NUMBER(4) DEFAULT 0 NOT NULL ENABLE,
...
CREATE TABLE repuesto(
	...
	nombre VARCHAR(50) NOT NULL ENABLE,
	descripcion VARCHAR(120),
	cant_existencia NUMBER NOT NULL ENABLE,
...
CREATE TABLE orden(
	...
	CONSTRAINT ORDEN_FK_SERIAL_EQUIPO FOREIGN KEY (serial_equipo) REFERENCES equipo(serial_equipo)
